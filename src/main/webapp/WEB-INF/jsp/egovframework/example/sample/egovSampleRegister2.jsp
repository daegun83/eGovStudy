...
<head>
    	...
    	$('#btn-login').click(function(){
    		var obj = {
           	        ...
           	        success : function (data) {
           	        	alert("a " + data);
           	            if (data=='true') {
           	            	//document.listForm.action = "<c:url value='/egovSampleList2.do'/>";
           	               	//document.listForm.submit();
           	               	location.href = '<c:url value='/egovSampleList2.do'/>';
           	            } else {
           	            	$('#dialog').dialog('close');        	            	
           	            }
           	        }     
    ...
    function fn_egov_session_check(){
    	var obj = {
       	        // type을 설정합니다.
       	        type : 'GET',
       	        cache: false,
    ...
    function ajaxSubmit(obj){
        ...
        function fn_egov_save() {
        	...
        	if(!validateSampleVO(frm)){
            	...
            	frm.action = "<c:url value="${registerFlag == 'create' ? '/addSample2.do' : '/updateSample2.do'}"/>";
                frm.submit();
            }
        }
...
<div id="dialog" title="로그인">
    ...
    <input type="text" value="비밀번호"/><br/>
    <input type="button" id="btn-login" size="30" value="로그인"/>
</div>
